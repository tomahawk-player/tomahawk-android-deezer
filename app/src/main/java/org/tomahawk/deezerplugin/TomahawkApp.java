...
@ReportsCrashes(
        ...
        formUri = "http://crash-stats.tomahawk-player.org:5984/acra-tomahawkdeezerplugin/_design/acra-storage/_update/report",
    ...
    public void onCreate() {
        ...
        try {
            StrictMode.setVmPolicy(new StrictMode.VmPolicy.Builder().detectLeakedSqlLiteObjects()
                    ...
                    .setClassInstanceLimit(Class.forName(DeezerService.class.getName()), 1)
                    .penaltyLog().build());
